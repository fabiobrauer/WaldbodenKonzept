...
import "./AgroforstWirtschaft.css"

function AgroforstWirtschaft() {
  return (
    <div className='container-fluid'> 

    <section className='row section'>
        <h1>Agroforstwirtschaft</h1>
        <p>Unter Agroforstwirtschaft versteht man die Integration von Gehölzen in landwirtschaftlichen Produktionssystemen, um durch Wechselwirkungen ökonomische und/oder ökologische Vorteile zu erzielen. Man unterscheidet silvoarable Systeme (Gehölze mit Ackerkulturen), silvopastorale Systeme (Gehölze mit Tierhaltung) und agrosilvopastorale Systeme (Gehölze mit Ackerkulturen und Tierhaltung).</p>
    ...
    <section className='row section'>   
    <div className="col-xs-12 col-md-6 p-5 text-wrap">
...
export default AgroforstWirtschaft